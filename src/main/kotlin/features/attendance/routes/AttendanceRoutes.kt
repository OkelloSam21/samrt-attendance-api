package features.attendance.routes

import common.responses.success
import features.attendance.models.CreateSessionRequest
import features.attendance.models.MarkAttendanceRequest
import io.ktor.http.*
...
fun Routing.configureAttendanceRoutes() {
    val attendanceService = di.AppInjector.attendanceService
    ...
    authenticate("auth-jwt") {
        route("/attendance") {
            ...
            put("/{id}/status/{status}") {
                ...
                val status = try {
                    domain.models.AttendanceStatus.valueOf(statusStr)
                } catch (e: IllegalArgumentException) {
