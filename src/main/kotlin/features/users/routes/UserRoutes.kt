package features.users.routes

import common.responses.success
import common.responses.successMessage
import features.users.models.CreateUserRequest
import features.users.models.UpdateUserRequest
import io.ktor.http.*
...
fun Routing.configureUserRoutes() {
    val userService = di.AppInjector.userService
