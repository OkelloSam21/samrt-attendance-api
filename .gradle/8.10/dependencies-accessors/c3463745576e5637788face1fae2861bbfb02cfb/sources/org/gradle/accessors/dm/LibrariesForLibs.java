...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory {
        private final KtorKotlinxLibraryAccessors laccForKtorKotlinxLibraryAccessors = new KtorKotlinxLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>ktor.kotlinx</b>
         */
        public KtorKotlinxLibraryAccessors getKotlinx() {
            return laccForKtorKotlinxLibraryAccessors;
        }
    ...
    public static class KtorKotlinxLibraryAccessors extends SubDependencyFactory {

        public KtorKotlinxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>serialization</b> with <b>io.ktor:ktor-serialization-kotlinx-json-jvm</b> coordinates and
         * with version reference <b>ktor.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSerialization() {
            return create("ktor.kotlinx.serialization");
        }
    ...
    public static class KtorServerContentLibraryAccessors extends SubDependencyFactory {
        private final KtorServerContentNegotiationLibraryAccessors laccForKtorServerContentNegotiationLibraryAccessors = new KtorServerContentNegotiationLibraryAccessors(owner);

        public KtorServerContentLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ktor.server.content.negotiation</b>
         */
        public KtorServerContentNegotiationLibraryAccessors getNegotiation() {
            return laccForKtorServerContentNegotiationLibraryAccessors;
        }

    }

    public static class KtorServerContentNegotiationLibraryAccessors extends SubDependencyFactory {

        public KtorServerContentNegotiationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>jvm</b> with <b>io.ktor:ktor-server-content-negotiation-jvm</b> coordinates and
         * with version reference <b>ktor.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJvm() {
            return create("ktor.server.content.negotiation.jvm");
        }
