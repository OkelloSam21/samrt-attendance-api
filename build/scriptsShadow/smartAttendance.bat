...
set CLASSPATH=%APP_HOME%\lib\smartAttendance-all.jar

@rem Execute smartAttendance
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SMART_ATTENDANCE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%SMART_ATTENDANCE_EXIT_CONSOLE%" exit 1
exit /b 1
